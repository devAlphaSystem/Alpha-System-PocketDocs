...
import { buildLoadMoreViewModel, formatDate, formatLongDate, formatLongDateTime, normalizeViewAssetList } from "./lib/view-helpers.js";
...
app.use((req, res, next) => {
  ...
  res.locals.buildLoadMoreViewModel = buildLoadMoreViewModel;
